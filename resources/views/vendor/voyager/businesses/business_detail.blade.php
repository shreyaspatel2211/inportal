    ...
    <div class="w-full px-4 py-12 pt-10 mt-8">
        ...
        <form id="wizardForm">
            ...
            <div class="step hidden" id="step-3">
                <div class="sm:flex gap-6 justify-between">
                    <div class="w-full">
                        <label class="text-color text-xl block">Your Phone Number</label>
                        <div> hello text </div>
                    </div>
                </div>
            </div>
            ...
            <div class="step hidden" id="step-4">
                <div class="sm:flex gap-6 justify-between">
                    <div class="w-full">
                        <label class="text-color text-xl block">Your Address</label>
                        <div> hello color </div>
                    </div>
                </div>
            </div>
            ...
            <div class="step hidden" id="step-5">
                <div class="sm:flex gap-6 justify-between">
                    <div class="w-full">
                        <label class="text-color text-xl block">Your Company Name</label>
                        <div> hello block </div>
                    </div>
                </div>
            </div>
            ...
            <div class="step hidden" id="step-6">
                <div class="sm:flex gap-6 justify-between">
                    <div class="w-full">
                        <label class="text-color text-xl block">Your Comments</label>
                        <div> hello full </div>
                    </div>
                </div>
            </div>
